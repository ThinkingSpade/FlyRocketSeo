...
const ProjectPProjectIdSerpRoute = ProjectPProjectIdSerpRouteImport.update({
  id: '/serp',
  path: '/serp',
  getParentRoute: () => ProjectPProjectIdRouteRoute,
} as any)
...
const ProjectPProjectIdPageRoute = ProjectPProjectIdPageRouteImport.update({
  id: '/page',
  path: '/page',
  getParentRoute: () => ProjectPProjectIdRouteRoute,
} as any)
...
const ProjectPProjectIdLinksRoute = ProjectPProjectIdLinksRouteImport.update({
  id: '/links',
  path: '/links',
  getParentRoute: () => ProjectPProjectIdRouteRoute,
} as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_project/p/$projectId/serp': {
      id: '/_project/p/$projectId/serp'
      path: '/serp'
      fullPath: '/p/$projectId/serp'
      preLoaderRoute: typeof ProjectPProjectIdSerpRouteImport
      parentRoute: typeof ProjectPProjectIdRouteRoute
    }
    '/_project/p/$projectId/search-performance': {
    ...
    '/_project/p/$projectId/page': {
      id: '/_project/p/$projectId/page'
      path: '/page'
      fullPath: '/p/$projectId/page'
    ...
    '/_project/p/$projectId/links': {
      id: '/_project/p/$projectId/links'
      path: '/links'
      fullPath: '/p/$projectId/links'
      preLoaderRoute: typeof ProjectPProjectIdLinksRouteImport
      parentRoute: typeof ProjectPProjectIdRouteRoute
    }
    '/_project/p/$projectId/keywords': {
    ...
    '/_project/p/$projectId/cannibalization': {
      ...
      path: '/cannibalization'
      fullPath: '/p/$projectId/cannibalization'
      preLoaderRoute: typeof ProjectPProjectIdCannibalizationRouteImport
      parentRoute: typeof ProjectPProjectIdRouteRoute
    }
    '/_project/p/$projectId/brand-lookup': {
...
interface ProjectPProjectIdRouteRouteChildren {
  ...
  ProjectPProjectIdSerpRoute: typeof ProjectPProjectIdSerpRoute
...
const ProjectPProjectIdRouteRouteChildren: ProjectPProjectIdRouteRouteChildren =
  {
    ...
    ProjectPProjectIdSearchPerformanceRoute:
      ProjectPProjectIdSearchPerformanceRoute,
    ProjectPProjectIdSerpRoute: ProjectPProjectIdSerpRoute,
