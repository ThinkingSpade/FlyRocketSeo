...
export const listProjectsTool = {
  ...
  config: {
    title: "List projects",
    description:
      "Lists all projects in the user's organization. Uses no credits — does not call DataForSEO. Use this whenever you need a `projectId` for another FlyRocketSEO tool. Returns an array of {id, name, domain}; pass the `id` value as `projectId`.",
